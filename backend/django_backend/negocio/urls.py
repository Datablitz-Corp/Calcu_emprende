...
from .views import ActualizarNegocioView,CrearNegocioCompleto_VAN_TIR, EliminarNegocioView,CrearNegocioView, ListaNegociosUsuarioView, EliminarNegocioView, CrearNegocioCompletoView, NegocioDetalleAPIView
...
urlpatterns = [
    ...
    path('negocio/nuevo/', CrearNegocioCompleto_VAN_TIR.as_view(), name='nuevo_negocio'),
    ...
    path('negocio/<int:negocio_id>/actualizar', ActualizarNegocioView.as_view()),
]
